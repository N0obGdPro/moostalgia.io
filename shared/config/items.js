...
exports.weapons = [{
    ...
    age: 2,
    name: "great axe",
	desc: "gathers resources at a higher rate but decreases overall speed",
    src: "axe_1",
    length: 140,
    width: 140,
    xOff: 3,
...
module.exports.list = [{
    ...
    type: 0,
    name: "sapling",
    desc: "allows you to farm wood but you can hide",
    req: ["wood", 150],
    ...
    type: 1,
    name: "shrub",
    desc: "allows you to collect food but you can hide",
